...
\end{itemize}
%Ref1 : Hennessy, J. L., & Patterson, D. A. "Computer Architecture: A Quantitative Approach", 6th Edition. ---- Branch Prediction | ScienceDirect (web)
% ya esta agregado como REF1
...
%ref2: Introduction to Side-Channel Attacks; Paul Kocher, Joshua Jaffe, Benjamin Jun. ---- 
\subsection{Spectre}
