...
\markboth{ORGANIZACION DEL COMPUTADOR - FIUBA 2024}{La inseguirdad del hardware actual}
\maketitle

\begin{abstract} 
  La seguridad del hardware actual se ha convertido en una preocupacion crítica en la era digital. Este informe profundiza en las vulnerabilidades que afectan a los procesadores contemporáneos, incluyendo ataques de canal lateral como Spectre y Meltdown, que explotan las optimizaciones de rendimiento para acceder a informacion sensible. Se analizan las tecnicas de mitigacion implementadas, como el aislamiento de tablas de paginas (KPTI), la aleatorizacion del diseño del espacio de direcciones del kernel (KASLR) y retpoline, que buscan contrarrestar estos ataques.
\end{abstract}

\begin{IEEEkeywords} 
  Seguridad del hardware, Vulnerabilidades del procesador, Ataques de canal lateral, Spectre, Meltdown, Predicción de saltos, Ejecucion especulativa, Mitigaciones de hardware, Mitigaciones de software, Prevención de ataques, KPTI, KASLR, Retpoline.
\end{IEEEkeywords}
...
Estas fugas de información indirecta son los llamados \textbf{canales laterales} \cite{Side Channel Attack}, que permiten al atacante obtener datos secretos sin acceder directamente a ellos. \newline
...
. Si el destino del salto del trampolin es una funcion, al retornar, dicha funcion regresara al llamador original del trampolin.\cite{retpoline1}\cite{retpoline2}
\begin{figure}[h]
  \centering
...
\bibitem{ref1} Hennessy, J. L., & Patterson, D. A. (2006). Computer Architecture: A Quantitative Approach (4a ed.). Morgan Kaufmann.

\bibitem{paralelismo} Paralelismo en las instrucciones, [Disponible]: https://orgacomp.github.io/9557/teoria/procesador/paralelismo/
\bibitem{Virtualizacion} Cap 9, Computer Systems: A Programmer’s Perspective (3.ª ed.) 2015 , Pearson.
\bibitem{syscall}  Linux system calls,” 2019. [Disponible]: http://man7.org/linux/man-pages/man2/syscalls.2.html. 
\bibitem{Aleatorización} Aleatorización del diseño del espacio de direcciones del núcleo, [Disponible]: https://bit.ly/aleatorizacion-kaslr.
\bibitem{PTI} Page Table Isolation, The Linux Kernel, [Disponible]: https://bit.ly/PageTableIso.
\bibitem{Rendimiento-Parches} Performance Impact of Host Kernel Page Table Isolation on Virtualized Servers, 2021, Song Wei; Kun Zhang; Bibo Tu, [Disponible]: https://ieeexplore.ieee.org/document/9421326.
...
\bibitem{KASLR} KASLR in the age of MicroVMs, 2022, [Disponible]: https://www.cc0x1f.net/publications/kaslr.pdf
\bibitem{TLB} Memory system, 2016, Sarah L. Harris, David Money Harris, in Digital Design and Computer Architecture, 2016. Papers varios: https://www.sciencedirect.com/topics/computer-science/translation-lookaside-buffer
\bibitem{PCID} Process Context IDentifiers, [Disponible]: https://www.kernel.org/doc/Documentation/x86/pti.txt, https://bit.ly/pciddoc.
\bibitem{Exploits-Parches} Linux kernel exploit development, 2022, [Disponible]: https://breaking-bits.gitbook.io/breaking-bits/exploit-development/linux-kernel-exploit-development
\bibitem{meltdown} Lipp, M., Schwarz, M., Gruss, D., Prescher, T., Haas, W., Fogh, A., Horn, J., Mangard, S., Kocher, P., Genkin, D., Yarom, Y., & Hamburg, M. (2018). Meltdown: Reading Kernel Memory from User Space. In *27th USENIX Security Symposium (USENIX Security 18)*.
\bibitem{spectre} Kocher, P., Horn, J., Fogh, A., Genkin, D., Gruss, D., Haas, W., Hamburg, M., Lipp, M., Mangard, S., Prescher, T., Schwarz, M., & Yarom, Y. (2019). Spectre Attacks: Exploiting Speculative Execution. In *40th IEEE Symposium on Security and Privacy (S\&P'19)*.
